  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* About Project & Team Section */}
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-10 shadow-xl border border-emerald-50 mb-20">
          <h2 className="text-3xl font-bold text-emerald-900 mb-6 text-center">
            About The Team
          </h2>
          <p className="text-lg text-emerald-700 text-center max-w-4xl mx-auto leading-relaxed mb-10">
            We are a passionate team of developers dedicated to bringing modern technological advancements into the agricultural sector. 
            Our mission is to empower farmers and agribusinesses by providing intelligent, AI-driven solutions that improve crop yields, optimize resource management, and foster sustainable farming practices. 
            By leveraging data and technology, we aim to build an ecosystem where agricultural challenges are met with smart, proactive interventions.
          </p>
          <div className="border-t border-emerald-100 pt-8 mt-8">
            <h3 className="text-2xl font-semibold text-emerald-800 mb-8 text-center">
              Project Developers
            </h3>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-8 md:gap-16">
              <div className="text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-green-600 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <span className="text-3xl font-bold text-white -rotate-3 group-hover:-rotate-6 transition-transform">M</span>
                </div>
                <h4 className="text-xl font-bold text-emerald-900">Manasi Navale</h4>
                <p className="text-sm text-emerald-600 mt-1">Developer</p>
              </div>
              <div className="text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-green-600 rounded-2xl -rotate-3 group-hover:-rotate-6 transition-transform flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <span className="text-3xl font-bold text-white rotate-3 group-hover:rotate-6 transition-transform">A</span>
                </div>
                <h4 className="text-xl font-bold text-emerald-900">Aditi More</h4>
                <p className="text-sm text-emerald-600 mt-1">Developer</p>
              </div>
              <div className="text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-green-600 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <span className="text-3xl font-bold text-white -rotate-3 group-hover:-rotate-6 transition-transform">C</span>
                </div>
                <h4 className="text-xl font-bold text-emerald-900">Chaitanya Mule</h4>
                <p className="text-sm text-emerald-600 mt-1">Developer</p>
              </div>
            </div>
          </div>
